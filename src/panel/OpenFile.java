...
public class OpenFile extends javax.swing.JPanel {
	...
	public OpenFile(controler.Controler controler) {
		...
		this.controler = controler;
                this.jFileChooser.setFileSelectionMode(javax.swing.JFileChooser.FILES_AND_DIRECTORIES);
   ...
   private void initComponents() {
      ...
      jSpinnerNumberOfRecords = new javax.swing.JSpinner();
      jLabelNRecors = new javax.swing.JLabel();
      jLabelSeparator = new javax.swing.JLabel();
      jTextFieldSeparator = new javax.swing.JTextField();

      jLabelChooser.setText("Seleziona il file");
      ...
      jSpinnerNumberOfRecords.setModel(new javax.swing.SpinnerNumberModel(1, 1, 10, 1));

      jLabelNRecors.setText("Numero di anagrafiche per record");

      jLabelSeparator.setText("Separatore CSV");
      ...
      layout.setHorizontalGroup(
         ...
         .addGroup(layout.createSequentialGroup()
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
               ...
               .addGroup(layout.createSequentialGroup()
                  .addContainerGap()
                  .addComponent(jLabelChooser, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                  .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                     .addComponent(jLabelNRecors)
                     .addComponent(jLabelSeparator))
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                  .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                     .addComponent(jTextFieldSeparator)
                     .addComponent(jSpinnerNumberOfRecords, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE))
      ...
      layout.setVerticalGroup(
         ...
         .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
               .addComponent(jSpinnerNumberOfRecords, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		if (evt.getActionCommand() == this.jFileChooser.APPROVE_SELECTION) {
		 updateUI = new controler.UpdateUI() {
				...
				action.put("file", jFileChooser.getSelectedFile());
                                action.put("nRecords", jSpinnerNumberOfRecords.getValue());
                                action.put("separator", jTextFieldSeparator.getText());
   ...
   private javax.swing.JLabel jLabelNRecors;
   private javax.swing.JLabel jLabelSeparator;
   private javax.swing.JSpinner jSpinnerNumberOfRecords;
